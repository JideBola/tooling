...
server {
    listen 80;
    server_name jenkins.jidebolarinwa.xyz;
...
sudo certbot --nginx -d jenkins.jidebolarinwa.xyz --email bolarinwaibrahimo@gmail.com --non-interactive --agree-tos --redirect
...
echo "Jenkins is now accessible"
